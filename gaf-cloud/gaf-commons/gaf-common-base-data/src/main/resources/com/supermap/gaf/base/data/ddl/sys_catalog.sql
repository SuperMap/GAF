...
CREATE TABLE "sys_catalog" ("catalog_id" VARCHAR(36) NOT NULL, "parent_id" VARCHAR(36), "sort_sn" INTEGER, "name" VARCHAR(255) NOT NULL, "type" VARCHAR(3), "code" VARCHAR(100), "icon_url" VARCHAR(500), "description" VARCHAR(500), "status" BOOLEAN DEFAULT TRUE, "created_time" TIMESTAMP WITHOUT TIME ZONE, "created_by" VARCHAR(255), "updated_time" TIMESTAMP WITHOUT TIME ZONE, "updated_by" VARCHAR(255), "tenant_id" VARCHAR(36), "biz_type_code" VARCHAR(3), CONSTRAINT "sys_catalog_pkey" PRIMARY KEY ("catalog_id"));
