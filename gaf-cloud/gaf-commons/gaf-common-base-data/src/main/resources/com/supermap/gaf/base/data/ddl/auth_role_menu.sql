...
CREATE TABLE "auth_role_menu" ("role_menu_id" VARCHAR(36) NOT NULL, "role_id" VARCHAR(36) NOT NULL, "status" BOOLEAN DEFAULT TRUE, "sort_sn" INTEGER, "description" VARCHAR(500), "created_time" TIMESTAMP WITHOUT TIME ZONE, "created_by" VARCHAR(255), "updated_time" TIMESTAMP WITHOUT TIME ZONE, "updated_by" VARCHAR(255), "resource_menu_id" VARCHAR(36) NOT NULL, CONSTRAINT "auth_role_module_copy1_pkey" PRIMARY KEY ("role_menu_id"));
COMMENT ON TABLE "auth_role_menu" IS '角色菜单表';
