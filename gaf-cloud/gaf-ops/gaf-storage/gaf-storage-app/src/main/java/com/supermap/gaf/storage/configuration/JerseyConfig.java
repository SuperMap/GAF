...
public class JerseyConfig extends ResourceConfig implements ServletConfigAware {
    ...
    public void configureSwagger() {
        ...
        config.setResourcePackage("com.supermap.gaf.storage.resource");
