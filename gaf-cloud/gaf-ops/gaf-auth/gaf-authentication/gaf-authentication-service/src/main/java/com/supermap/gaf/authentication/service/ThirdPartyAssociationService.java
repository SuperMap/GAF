 ...
 */
@Service
public interface ThirdPartyAssociationService {
     ...
     * @return
     */
    ThirdPartyAssociation getByEnabledThirdPartyAndThirdPartyUserName(String enabledThirdParty, String thirdPartyUsername);
}
