 ...
 * @author SuperMap
 */
public class CtrlActionDatasourceView extends CtrlActionDockbar {
	public CtrlActionDatasourceView(IBaseItem caller) {
		super(caller);
	}

	protected String getDockbarClassName() {
		return GafDatasourceManager.class.getName();
	}
}
