...
base() {
    ...
    wait_container_health gaf-microservice-rigister
    wait_container_health gaf-microservice-conf


    #启动其他GAF基础应用
    docker-compose up -d gaf-microservice-api gaf-microservice-gateway gaf-sys-mgt gaf-authentication gaf-authority gaf-microservice-governance gaf-portal gaf-map gaf-data-mgt gaf-storage gaf-analysis gaf-webapp gaf-mapapp
