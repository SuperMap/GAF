<template>
  <div class="app-container">
    <div class="page-single">
      <div class="func-top">
        ...
        <div class="btn-box">
          ...
          >
            ...
            <div class="yesAndno">
              <button type="submit" class="submit-gray" @click="acceptSubmit">
                确认
              </button>
      ...
      <div class="all-top">
        <a-tabs default-active-key="1" class="tab-smallbox" @change="callback">
          <a-tab-pane key="1" tab="流程信息">
            <div class="all-box">
              <div class="box-left">
                <div class="left-l">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <b class="tags tags_proinststate">
                        ...
                        <i name="HangingUp" class="layout-hide HangingUp"
                          >挂起</i
                        >
                        <i name="Locked" class="layout-hide Locked">锁定</i>
                        <i name="Supervised" class="layout-hide Supervised"
                          >督办</i
                        >
              ...
              <div class="box-right">
                ...
                >
                  ...
                  <li>
                    ...
                    <b class="tags tags_proinsttype">
                      <i
                        :class="handlerType.get(item.ActInst_Type).className"
                        >{{ handlerType.get(item.ActInst_Type).name }}</i
                      >
                    </b>
                  </li>
                  <li>
            ...
            <div class="layout-vertical" style="position: relative">
              ...
              >
                <span
                  style="color: #019688; line-height: 35px; padding-left: 15px"
                  >流程图：</span
                >
              </div>
              <div
              ...
              >
                <button
                  ...
                  data-readonly="false"
                >
                  <a-icon type="zoom-in" class="zoomIn" />
                </button>
                <button
                  name="zoomOut"
          ...
          <a-tab-pane key="2" class="tab-smallbox" tab="组件" force-render>
            <iframe
              src="http://192.168.192.100:30756/workflow/view/component/table.html"
              width="100%"
...
export default {
  ...
  methods: {
    ...
    closeSkip() {
      this.$router.push({
        path: '../../../pages/workflow/GafNeedDealtBox',
      })
    },
    /* 挂起 */
    hangUp() {
    ...
    async acceptSubmit() {
      ...
      if (acceptTransfer.data.isSuccessed) {
        this.$router.push({
          path: '../../workflow/GafAcceptBox',
        })
      } else {
        this.$message.error(`${acceptTransfer.data.message}`)
      }
    },
    async acceptSubmitTransfer() {
      ...
      if (transferOutInfo.data.isSuccessed) {
        this.$router.push({
          path: '../../workflow/GafAcceptBox',
        })
      } else {
        this.$message.error(`${transferOutInfo.data.message}`)
      }
    },
    async acceptSubmitReject() {
      ...
      if (acceptReject.data.isSuccessed) {
        this.$router.push({
          path: '../../workflow/GafAcceptBox',
        })
      } else {
        this.$message.error(`${acceptReject.data.message}`)
      }
    },
    /* 功能键 模态框 树组件遍历 */
    ...
    async getTable() {
      ...
      /* 组件获取 */
      this.componentsData = this.dataZ.componentsData
      const i = {
        ProInst_Type: {
          Normal: 1010,
          Urgent: 2010,
